...
\item \textbf{Performance Impact}: Thread synchronization overhead measured at 48.2\% latency increase in split model approach (see Section~\ref{subsec:performance-analysis}), demonstrating the importance of minimizing inter-thread coordination
