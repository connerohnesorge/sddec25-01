...
parallelized CPU processing and sequential DPU scheduling (33.2ms for 4 frames).
...
\begin{itemize}
  \item \textbf{Algorithm Analysis}: Comprehensive analysis of the
    U-Net semantic segmentation architecture for parallelization and
  ...
  \item \textbf{Performance Optimization}: Parallelized CPU processing
    with sequential DPU scheduling implementation for throughput improvements
...
through intelligent sequential DPU scheduling and parallelized CPU processing
rather than hardware upgrades. Broader implications:
...
\begin{itemize}
  ...
  \item \textbf{real-time Processing}: Techniques for achieving
    ...
    through efficient parallelized processing and sequential resource scheduling
