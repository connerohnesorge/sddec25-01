...
This project has addressed the challenge of optimizing semantic
segmentation algorithms for real-time eye tracking in assistive
technology applications. Our approach has demonstrated progress
toward achieving the target specifications of maintaining 99.8\% IoU
accuracy while improving processing speed from 160ms per frame to
approximately 8.3ms per frame average through pipelined processing
(33.2ms total for 4 frames in the pipeline).
...
Our project contributes to the field of embedded AI systems by
demonstrating that performance improvements can be achieved through
intelligent sequential DPU scheduling and pipelined processing rather
than hardware upgrades. This approach has broader implications for:
...
The potential social impact of this project extends beyond technical
achievements:
...
This project addresses the intersection of artificial intelligence,
embedded systems, and assistive technology. By addressing the complex
challenge of optimizing semantic segmentation for real-time eye
tracking, we have demonstrated that algorithm design and resource
management can overcome hardware limitations.

The journey from concept to implementation has provided insights into
the challenges and opportunities of developing AI-powered assistive
technologies. The technical work, combined with understanding of user
needs and constraints, has resulted in a solution that may improve
the capabilities of assistive systems for individuals with mobility impairments.

By enabling more responsive and reliable assistive technologies, this
work contributes to the development of systems that support
individuals with disabilities in maintaining greater independence.

\section{Acknowledgments}\label{sec:acknowledgments}

We would like to acknowledge the support and guidance provided
...
This project demonstrates interdisciplinary collaboration and
technical development in assistive technology systems.
