...
\begin{itemize}
  \item JR Spidell -- Client guidance and domain expertise in assistive wheelchair technology
\end{itemize}
...
\begin{itemize}
  \item Dr.\ Namrata Vaswani -- Faculty advisor and project supervision
\end{itemize}
